...
const EntregadoreslistIndexRoute = EntregadoreslistIndexRouteImport.update({
  id: '/entregadores/(list)/',
  path: '/entregadores/',
  getParentRoute: () => rootRouteImport,
} as any)
const CuponslistIndexRoute = CuponslistIndexRouteImport.update({
  id: '/cupons/(list)/',
  path: '/cupons/',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/entregadores/(list)/': {
      ...
      preLoaderRoute: typeof EntregadoreslistIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/cupons/(list)/': {
      id: '/cupons/(list)/'
      path: '/cupons'
      fullPath: '/cupons/'
      preLoaderRoute: typeof CuponslistIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/configuracoes/(list)/': {
      id: '/configuracoes/(list)/'
